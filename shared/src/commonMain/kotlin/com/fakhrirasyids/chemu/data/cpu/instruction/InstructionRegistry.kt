package com.fakhrirasyids.chemu.data.cpu.instruction

import com.fakhrirasyids.chemu.data.cpu.instruction.system.*
import com.fakhrirasyids.chemu.data.cpu.instruction.display.*
import com.fakhrirasyids.chemu.data.cpu.instruction.keyboard.*
import com.fakhrirasyids.chemu.data.cpu.instruction.timers.*
import com.fakhrirasyids.chemu.data.cpu.instruction.control.*
import com.fakhrirasyids.chemu.data.cpu.instruction.arithmetic.*
import com.fakhrirasyids.chemu.data.cpu.instruction.memory.*
import com.fakhrirasyids.chemu.data.cpu.instruction.random.*
import com.fakhrirasyids.chemu.data.cpu.instruction.system.*
...
object InstructionRegistry {
    ...
    fun find(opcode: OPCode): Instruction? {
        ...
        // 1. Try direct match first (e.g. 0x00EE)
